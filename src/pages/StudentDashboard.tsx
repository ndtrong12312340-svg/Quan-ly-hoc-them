...
export default function StudentDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'profile' | 'knowledge' | 'exams'>('profile');
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 relative overflow-hidden">
      {/* Sidebar */}
      <aside className="w-72 bg-[#0d1326] border-r border-[#1a2238] flex flex-col fixed inset-y-0 left-0 z-50">
        <div className="p-6 pb-2">
          <div className="flex items-center space-x-3 mb-8">
            <div className="w-10 h-10 rounded-[1rem] bg-blue-600 flex flex-col items-center justify-center text-white shadow-lg shadow-blue-500/30">
          ...
          <nav className="space-y-1">
            ...
            >
              <User className="w-5 h-5 mr-3" strokeWidth={activeTab === 'profile' ? 2.5 : 1.5} />
              Thông tin cá nhân
            </button>
            <button
            ...
            >
              <CheckCircle className="w-5 h-5 mr-3" strokeWidth={activeTab === 'exams' ? 2.5 : 1.5} />
              Làm bài & Kết quả
            </button>
          </nav>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-8">
          <div className="flex justify-between items-center mb-8 pb-6 border-b border-slate-200">
            <h2 className="text-2xl font-bold text-slate-800">
              ...
              {activeTab === 'exams' && 'Làm bài & Kết quả'}
            </h2>
